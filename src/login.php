...
?>
	<center>
		<h1><?php echo $MESSAGES["APP_NAME"]; ?></h1>
	</center>
	<center>
	...
	<form name="login" action=<?php echo $_SERVER["PHP_SELF"]; ?> method="post">
		<table border=0 align="center">
			<tr>
				<td>
					<table border=0 align="center">
						<tr>
							<td colspan=2>
								<h2><?php echo $MESSAGES["APP_LOGIN_TITLE"]; ?></h2>
							</td>
						</tr>
						<tr>
							<td><?php echo $MESSAGES["APP_LOGIN_USERNAME"] ?></td>
							<td><input type=text name="username" value="<?php echo $username; ?>" /></td>
						</tr>
						<tr>
							<td>
								<?php echo $MESSAGES["APP_LOGIN_PASSWORD"] ?></td>
			...
			<tr>
				<td></td>
				<td><input type="submit" value=<?php echo $MESSAGES["APP_ACCEPT"] ?>></td>
			</tr>
		</table>
		</td>
		<td>
		...
		?>
			<table border=0 align="center">
				<tr>
					<td><?php echo $MESSAGES["WANT_REGISTER"]; ?></td>
				</tr>
			</table>
		<?php
		}
