...
class datawindow_query
{
	...
	{
		return $this->get_property("joins", "and");
	}
	...
	{
		return $this->get_property("group_by", "and");
	}
	...
	public function add_custom_restriction($restriction)
	{
		$this->custom_restriction[] = $restriction;
	}
	protected function get_custom_restriction()
	{
		return $this->get_property("custom_restriction", "and");
	}
	...
	public function get_cell_color($field, $value)
	{
		return "";
	}
}
