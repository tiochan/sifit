...
<head>
	...
	<meta name="description" content="Vulnerability management service" />
	<meta name="keywords" content="Vulnerability, management service, advisory, CERT" />
	<style type='text/css'>
		{
			STYLE
		}
...
<body text='#000000'>
	<table align='center' border='0' cellpadding='2' cellspacing='2' width='700'>
		<tbody>
			...
			<tr>
				<div>
					<{IMAGE {SYSHOME}/include/images/logo1.png}> </tr> </tbody> </table> </body> </html>