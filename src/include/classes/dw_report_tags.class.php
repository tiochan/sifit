...
class dw_report_tags extends datawindow_ext
{
	...
	public function dw_report_tags(&$optional_db = null)
	{
		...
		//			$fields[]= new field_ext("report_tags.tag_name",$MESSAGES["TAGS_FIELD_NAME"],"fstring",true,true,1,true);
...
?>
		<div style='display: table-row;'>
			...
			?>
				...
				?>
					<select class='courier' name='<?php echo $this->rand_name; ?>' onchange='javascript:if(<?php echo $this->rand_name; ?>.selectedIndex > 1) {
